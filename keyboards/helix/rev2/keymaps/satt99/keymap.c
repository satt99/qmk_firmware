...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----+----+     +----+----+----+----+----+----+----|
     COPY,PST ,LGUI,LALT,IMOF,P_LW,SPCT,      ENSF,P_RS,IMON,LEFT,DOWN, UP ,RGHT
  //|----+----+----+----+----+----+----+     +----+----+----+----+----+----+----|
  ),

  [_JIS2US] = LAYOUT_kc(
  //,----+----+----+----+----+----+               +----+----+----+----+----+----.
     GRV ,FN0 ,FN0 ,FN0 ,FN0 ,FN0 ,                FN0 ,FN0 ,FN0 ,FN0 ,FN0 ,FN0 ,
  //,----+----+----+----+----+----+               +----+----+----+----+----+----.
     ESC , Q  , W  , E  , R  , T  ,                 Y  , U  , I  , O  , P  ,DEL ,
  //|----+----+----+----+----+----+               +----+----+----+----+----+----|
     TAB , A  , S  , D  , F  , G  ,                 H  , J  , K  , L  ,FN0 ,BSPC,
  //|----+----+----+----+----+----+----+     +----+----+----+----+----+----+----|
   ...
   */
    [_LOWER] = LAYOUT(
        ...
        _______, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_LPRN, KC_RPRN, KC_F12, _______, _______, KC_HOME, KC_END, KC_PIPE,
  ...
  //|----+----+----+----+----+----+               +----+----+----+----+----+----|
         , F1 , F2 , F3 , F4 , F5 ,                JYEN,MINS,UNDS,RBRC,BSLS,    ,
  //|----+----+----+----+----+----+----+     +----+----+----+----+----+----+----|
         , F7 , F8 , F9 , F10, F11, F12,       F6 ,SYEN,SRO ,COLN,RCBR,PIPE,    ,
  //|----+----+----+----+----+----+----+     +----+----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,    ,          ,    ,    ,    ,    ,    ,    
  //|----+----+----+----+----+----+----+     +----+----+----+----+----+----+----|
  ),
   ...
   */
    [_RAISE] = LAYOUT(
        ...
        _______, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, _______, _______, KC_F12, _______, _______, KC_PGDN, KC_PGUP, KC_BSLS,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY),
   ...
   * |      | Reset|RGBRST|      |      |      |             |      |      |      |      |      |  Del |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      |Aud on|Audoff| Mac  |             | Win  |Qwerty|QwertM|      |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |RGB ON| HUE+ | SAT+ | VAL+ |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      | MODE | HUE- | SAT- | VAL- |
   ...
   */
    [_ADJUST] = LAYOUT(
        ...
        _______, _______, _______, AU_ON, AU_OFF, AG_NORM, AG_SWAP, QWERTY, JIS2US, _______, _______, _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record)
{
  ...
  case JIS2US:
    if (record->event.pressed)
    {
      ...
      PLAY_SONG(tone_qwerty);
#endif
      persistent_default_layer_set(1UL << _JIS2US);
    }
    return false;
    break;
  case LOWER:
  ...
  case LJ2US:
    if (record->event.pressed)
    {
      ...
      layer_on(_LJIS2US);
      update_tri_layer_RGB(_LJIS2US, _RJIS2US, _ADJUST);
    }
    else
    {
#ifdef RGBLIGHT_ENABLE
...
#define L_ADJUST_TRI 65556
#define L_ADJUST_TRI2 65576

static void
render_logo(struct CharacterMatrix *matrix)
{
